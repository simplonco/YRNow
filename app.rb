...
def video_list
  soin = [{"REF"=>8, "Type"=> "SOIN", "Libellé_conseil"=> "Mon rituel hydratation", "Lien_Youtube"=> "<iframe width='560' height='315' src='//www.youtube.com/embed/fmttJ7ya9V4' frameborder='0' allowfullscreen></iframe>", "Age_Debut"=> 20, "Age_Fin"=> 40, "cle_age" => 1, "Skin type"=> "dehydrated skin", "Weather"=> "all", "Produit 1"=> 71991, "Produit 2"=> 33247, "Produit 3"=> 18786, "Produit 4"=> 70086}, {"REF"=>9, "Type"=> "SOIN", "Libellé_conseil"=> "Sérum + crème : le tandem belle peau", "Lien_Youtube"=> "<iframe width='560' height='315' src='//www.youtube.com/embed/FOLe7KJ8bE4' frameborder='0' allowfullscreen></iframe>", "Age_Debut"=> 40, "Age_Fin"=> 70, "Skin type"=> "all", "Weather"=> "all", "Produit 1"=> 76668, "Produit 2"=> 73952, "Produit 3"=> 02103, "Produit 4"=> 74422, "cle_age" => 2,},{"REF"=>10, "Type"=> "SOIN", "Libellé_conseil"=> "Préparer sa peau au soleil", "Lien_Youtube"=> "<iframe width='560' height='315' src='//www.youtube.com/embed/OrjAd7vN-mE' frameborder='0' allowfullscreen></iframe>", "Age_Debut"=> 0, "Age_Fin"=> 80, "Skin type"=> "all", "Weather"=> "Good Weather", "Produit 1"=> 11865, "Produit 2"=> 14259, "Produit 3"=> 23797, "Produit 4"=> 26852, "cle_age" => 3},{"REF"=>11, "Type"=> "SOIN", "Libellé_conseil"=> "Peaux sèches et rides : tous les conseils", "Lien_Youtube"=> "<iframe width='560' height='315' src='//www.youtube.com/embed/6xp-sDM3hzw' frameborder='0' allowfullscreen></iframe>", "Age_Debut"=> 40, "Age_Fin"=> 70, "Skin type"=> "dry skin", "Weather"=> "Bad Weather", "Produit 1"=> 20890, "Produit 2"=> 36325, "Produit 3"=> 38362, "Produit 4"=> 17114, "cle_age" => 2},{"REF"=>12, "Type"=> "SOIN", "Libellé_conseil"=> "Mes soins beauté express", "Lien_Youtube"=> "<iframe width='560' height='315' src='//www.youtube.com/embed/kK0dIY-Uj1A' frameborder='0' allowfullscreen></iframe>", "Age_Debut"=> 0, "Age_Fin"=> 80, "Skin type"=> "dehydrated skin", "Weather"=> "Good Weather", "Produit 1"=> 27606, "Produit 2"=> 65293, "Produit 3"=> 86551, "Produit 4"=> 86551, "cle_age" => 3}]
  ...
  @video = soin.select {|e| e["Skin type"] == params["skin_type"] }[0]["Lien_Youtube"]
end   
